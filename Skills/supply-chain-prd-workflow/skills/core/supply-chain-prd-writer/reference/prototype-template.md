...
- 覆盖页面：
- 不覆盖内容：
- 原型形式：Markdown 低保真多页静态稿（默认） / HTML 原型（确认后可输出） / 图片原型 / 其他
...
- 默认以 PC 端业务页面为主，若涉及仓内 PDA 或平板端，需要单独说明适配约束
...
|----------|----------|----------|----------|------------|
| P-001 | 示例页面 | 示例目标 | 示例角色 | INT-001 / UC-001 |
...
|------|------|------|------------|----------|----------|----------|
| 示例按钮 | 页面右上角 | 示例权限 | 示例行为 | 示例提示 | 示例提示 | 示例数据变更 |
...
|----------|----------|----------|----------|----------|----------|
| 示例操作 | 弹窗/抽屉/页面 | 示例内容 | 示例行为 | 示例行为 | 示例校验/结果 |
